          ...
          {cases.map((c, i) => (
            ...
            >
              <div className="p-4 border-b border-gray-200">
                <p className="text-[10px] font-bold text-red-600 uppercase tracking-wide mb-1">Violation Found</p>
                <p className="text-sm font-semibold text-gray-900">{c.violation}</p>
              </div>
              <div className="p-4 bg-accent/5">
                ...
                <p className="text-xs text-gray-500 mt-1">{c.outcome} · {c.state}</p>
              </div>
            </div>
          ))}
        </div>
