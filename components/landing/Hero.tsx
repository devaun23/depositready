  ...
  return (
    <section className="relative pt-28 sm:pt-32 pb-20 sm:pb-28 overflow-hidden">
      ...
      <div className="relative z-10 max-w-2xl mx-auto px-5 text-center">
        ...
        >
          <p className="mt-5 text-base sm:text-lg text-muted max-w-md mx-auto leading-relaxed">
        ...
        >
          <div className="mt-10 flex items-center justify-center gap-5 text-xs text-muted/70">
