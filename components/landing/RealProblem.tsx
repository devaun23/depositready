    ...
    <section ref={ref as React.RefObject<HTMLElement>} className="py-16 sm:py-24 px-4">
      <div className="max-w-5xl mx-auto">
        <div className={`max-w-2xl mx-auto text-center ${visible ? "animate-fadeSlideUp" : "opacity-0"}`} style={{ animationFillMode: "both" }}>
          <p className="text-xs font-semibold text-accent uppercase tracking-[0.15em] mb-3">The Real Problem</p>
        ...
        <p className={`text-center mt-8 text-sm font-medium text-accent ${visible ? "animate-fadeSlideUp" : "opacity-0"}`} style={{ animationDelay: visible ? "200ms" : undefined, animationFillMode: "both" }}>
