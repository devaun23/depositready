    ...
    <section className="py-12 md:py-16">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap mb-8">
        <Link
          ...
          className="inline-block rounded-md bg-accent px-8 py-4 text-white font-semibold hover:bg-accent-hover transition-all text-center shadow-lg hover:shadow-xl text-lg btn-touch"
        >
          {primaryButton.text}
        </Link>
        {secondaryButton && (
